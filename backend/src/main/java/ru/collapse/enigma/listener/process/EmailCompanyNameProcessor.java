...
public class EmailCompanyNameProcessor {
    ...
    private static final String SYSTEM = """
            ...
            4. NULL - это не строка, а json тип
            ...
            8. Не используй разметку MARKDOWN, НЕ ОБОРАЧИВАЙ в ```
            
            Письмо: "Здравствуйте, пишем от имени ГазПром Инжиниринг, нужна консультация по оборудованию."
            Ответ:
            {
              "company": "ГазПром Инжиниринг"
            }
            
            Письмо: "У нас есть вопрос по вашему продукту."
            Ответ:
            {
              "company": null
            }
